...
The first thing I notice when I look at our results. Besides the intercept, every single p-value is far above .05, which makes them all statistically insignificant. Therefore we fail to reject the null hypothesis. It makes sense to me that this interaction is insignificant, because the slopes we were getting were very surprising and didn't make much logical sense to me. We cannot assume that any of the interaction trends we saw were not just due to chance. 
...
https://www.sscnet.ucla.edu/polisci/faculty/ross/papers/working/Ross%20-%20Politics%20of%20the%20resource%20curse.pdf?form=MG0AV3 
