...
geo_join_sf <- st_as_sf(geo_join, 
                        coords = c("longitude", "latitude"),
                        crs = "EPSG:4326")

geo_join.nb <- dnearneigh(geo_join_sf, d1 = 0, d2 = 5000)
...
ggplot() + 
  geom_sf(data = world, fill = "lightgray", color = "darkgray") +   geom_sf(data = geo_join_sf, aes(color = residual)) + scale_color_viridis_c() + 
  labs( title = "Residuals on World Map", subtitle = "Overlay of Spatial Data and World Map", x = "Longitude", y = "Latitude" ) + theme_minimal()
